...
urlpatterns = [
    ...
    path('personnes/edition/profil/add-dataset-maintainer/<path:ark_pid>', views_person.person_datasets_maintainer_addition, name='person_datasets_maintainer_addition'),
    path('personnes/edition/profil/delete-dataset-maintainer/<path:ark_pid>', views_person.person_datasets_maintainer_deletion, name='person_datasets_maintainer_deletion'),
    path('personnes/edition/profil/add-dataset-creator/<path:ark_pid>', views_person.person_datasets_creator_addition, name='person_datasets_creator_addition'),
    path('personnes/edition/profil/delete-dataset-creator/<path:ark_pid>', views_person.person_datasets_creator_deletion, name='person_datasets_creator_deletion'),
