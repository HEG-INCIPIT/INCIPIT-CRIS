...
urlpatterns = [
    ...
    path('persons/edition/profil/add-article/<path:ark_pid>', views_person.person_article_addition, name='person_article_addition'),
    path('persons/edition/profil/delete-article/<path:ark_pid>', views_person.person_article_deletion, name='person_article_deletion'),
    path('persons/edition/profil/add-project/<path:ark_pid>', views_person.person_project_addition, name='person_project_addition'),
    path('persons/edition/profil/delete-project/<path:ark_pid>', views_person.person_project_deletion, name='person_project_deletion'),
    path('persons/edition/profil/add-dataset-maintainer/<path:ark_pid>', views_person.person_datasets_maintainer_addition, name='person_datasets_maintainer_addition'),
    path('persons/edition/profil/delete-dataset-maintainer/<path:ark_pid>', views_person.person_datasets_maintainer_deletion, name='person_datasets_maintainer_deletion'),
    path('persons/edition/profil/add-dataset-creator/<path:ark_pid>', views_person.person_datasets_creator_addition, name='person_datasets_creator_addition'),
    path('persons/edition/profil/delete-dataset-creator/<path:ark_pid>', views_person.person_datasets_creator_deletion, name='person_datasets_creator_deletion'),
    path('persons/edition/profil/<str:part_of_person_to_modify>/<path:ark_pid>', views_person.person_field_edition, name='person_field_edition'),
    path('persons/edition/<path:ark_pid>', views_person.person_edition, name='person_edition_display'),
    path('persons/<path:ark_pid>', views_person.person_profile, name='person_profile'),
    ...
    path('projects/edition/field/add-dataset/<path:ark_pid>', views_project.project_dataset_addition, name='project_dataset_addition'),
    path('projects/edition/field/delete-dataset/<path:ark_pid>', views_project.project_dataset_deletion, name='project_dataset_deletion'),
    ...
    path('datasets/edition/field/add-creator/<path:ark_pid>', views_dataset.dataset_creator_addition, name='dataset_creator_addition'),
    path('datasets/edition/field/delete-creator/<path:ark_pid>', views_dataset.dataset_creator_deletion, name='dataset_creator_deletion'),
    path('datasets/edition/field/add-maintainer/<path:ark_pid>', views_dataset.dataset_maintainer_addition, name='dataset_maintainer_addition'),
    path('datasets/edition/field/delete-maintainer/<path:ark_pid>', views_dataset.dataset_maintainer_deletion, name='dataset_maintainer_deletion'),
    path('datasets/edition/field/add-project/<path:ark_pid>', views_dataset.dataset_project_addition, name='dataset_project_addition'),
    path('datasets/edition/field/delete-project/<path:ark_pid>', views_dataset.dataset_project_deletion, name='dataset_project_deletion'),
