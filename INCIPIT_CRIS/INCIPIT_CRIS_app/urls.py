...
urlpatterns = [
    ...
    path('articles/edition/field/delete-article/<path:ark_pid>', views_article.article_deletion, name='article_deletion'),
    ...
    path('projects/edition/field/delete-project/<path:ark_pid>', views_project.project_deletion, name='project_deletion'),
